...
const DEMO_PAGES: Page[] = [
  {
    ...
    shopify_url: 'https://demo-store.myshopify.com/products/crema-vitamina-c',
    slug: null,
    settings: {
      price: '39.90',
      ...
      direct_exit_url: 'https://demo-store.myshopify.com/products/crema-vitamina-c',
    },
    safe_score: 92,
  ...
  },
  {
    id: 'demo-page-2',
    user_id: 'demo-user-1',
    username: 'skinglow-bundle',
    type: 'simple',
    status: 'published',
    title: 'Bundle Skincare × 3',
    brand_name: 'SkinGlow',
    product_name: 'Kit Completo Skincare',
    shopify_url: 'https://demo-store.myshopify.com/products/bundle-3',
    slug: null,
    settings: {
      price: '89.90',
  ...
  },
  {
    ...
    shopify_url: 'https://demo-store.myshopify.com/products/serum-retinol',
    slug: null,
    settings: {
      price: '44.90',
