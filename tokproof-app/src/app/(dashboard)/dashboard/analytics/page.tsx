  ...
  return (
    <>
      ...
      <div className="db-stats">
        <div className="db-stat"><div className="db-stat-lbl">Visitantes únicos</div><div className="db-stat-val">—</div></div>
        <div className="db-stat"><div className="db-stat-lbl">CTA clicks</div><div className="db-stat-val v-pink">—</div></div>
        <div className="db-stat"><div className="db-stat-lbl">CTR</div><div className="db-stat-val v-pink">—</div></div>
        <div className="db-stat"><div className="db-stat-lbl">Fuente #1</div><div className="db-stat-val v-purple">—</div></div>
        <div className="db-stat"><div className="db-stat-lbl">Conversiones est.</div><div className="db-stat-val v-success">—</div></div>
      </div>

      {/* Per-page table */}
      <div className="db-sec-hd">
        <h2>Por página</h2>
        <span className="db-count">{pages?.length ?? 0}</span>
      </div>
            ...
            <tbody>
              {pages.map(page => (
                <tr key={page.id} style={{ borderBottom: '1px solid var(--border)' }}>
                  ...
                  {['—','—','—','—'].map((v, i) => (
                    <td key={i} style={{ padding: '14px 16px', color: 'var(--muted2)' }}>{v}</td>
                  ))}
                </tr>
              ))}
            </tbody>
