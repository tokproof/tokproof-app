...
export const TEMPLATES: Template[] = [
  // ── ECOMMERCE ─────────────────────────────────────────────────────────────
  {
    ...
    description: 'Landing page viral para un producto estrella. Diseñada para convertir desde TikTok.',
    features:    ['Video hero del producto', 'CTA de compra directa', 'Urgencia y escasez'],
    previewType: 'product',
    checkColor:  'green',
    btnVariant:  'pink',
    pageType:    'trust',
