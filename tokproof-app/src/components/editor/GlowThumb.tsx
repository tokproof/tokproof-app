...
// ─── partner_discounts ────────────────────────────────────────────────────────
function PartnerDiscountsThumb({ size }: { size: ThumbSize }) {
  const brands = [
    { name: 'Gymshark', init: 'GS', code: 'GYM15', disc: '15% OFF', popular: true },
    { name: 'LSKD',     init: 'LS', code: 'LSKD20', disc: '20% OFF', popular: false },
